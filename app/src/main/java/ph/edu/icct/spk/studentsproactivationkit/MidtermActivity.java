...
public class MidtermActivity extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        Button btn_midterm_grade = (Button)findViewById(R.id.btn_midterm_grade);
        ...
        btn_info.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                AlertDialog.Builder diag = new AlertDialog.Builder(MidtermActivity.this);
                ...
                data.add(map);
                SimpleAdapter adapter = new SimpleAdapter(MidtermActivity.this, data,
        ...
        btn_quiz.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                grade_Handler("Midterm Quizzes", selected_code, "quiz", MidtermActivity.this, GradeList.class);
            }
        });
        ...
        btn_recitation.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                grade_Handler("Midterm Recitations", selected_code, "recitation", MidtermActivity.this, GradeList.class);
            }
        });
        ...
        btn_project.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                grade_Handler("Midterm Projects", selected_code, "project", MidtermActivity.this, GradeList.class);
            }
        });
        ...
        btn_assignment.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                grade_Handler("Midterm Assignments", selected_code, "assignment", MidtermActivity.this, GradeList.class);
            }
        });
        ...
        btn_exam.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                grade_Handler("Midterm Exam", selected_code, "exam", MidtermActivity.this, GradeList.class);
            }
        });

        // END PERIOD GRADE
        btn_midterm_grade.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                grade_Handler("Midterm Grade", selected_code, "midterm", MidtermActivity.this, EndperiodActivity.class);
            }
        });
    }
